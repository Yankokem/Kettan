...
1. Approved — Loading State (SR Page)
...
1. Post-Arrival Branch Checklist (Order Processing — Branch)
...
1. New Status: Completed (Order Processing + SR Page resolved)
