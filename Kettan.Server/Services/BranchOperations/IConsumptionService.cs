...
public interface IConsumptionService
{
    ...
    Task<List<ConsumptionLogDto>> ListAsync(DateTime? from = null, DateTime? to = null, string? method = null, int? branchId = null);
    Task<List<PreviewDeductionDto>> PreviewDeductionsAsync(List<SalesConsumptionLineDto> sales);
}
