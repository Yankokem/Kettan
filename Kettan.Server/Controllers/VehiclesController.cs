...
public class VehiclesController : ControllerBase
{
    ...
    public VehiclesController(ApplicationDbContext context, ICurrentUserService currentUser)
    {
        _context = context;
    ...
    [HttpGet]
    public async Task<ActionResult<List<VehicleDto>>> GetVehicles([FromQuery] bool includeInactive = false)
    {
    ...
    public async Task<ActionResult<VehicleDto>> GetVehicle(int id)
    {
        ...
        var row = await _context.Vehicles.FirstOrDefaultAsync(v => v.VehicleId == id);
