...
public class SupplyRequestsController : ControllerBase
{
    ...
    [HttpPut("{id:int}")]
    public async Task<ActionResult<SupplyRequestDto>> UpdateSupplyRequest(int id, [FromBody] UpdateSupplyRequestDto dto)
    {
        try
        {
    ...
    public async Task<ActionResult<SupplyRequestDto>> ApproveSupplyRequest(int id, [FromBody] ApproveSupplyRequestDto dto)
    {
        try
        {
    ...
    [Authorize(Roles = "TenantAdmin,HqManager,HqStaff")]
    public async Task<ActionResult<SupplyRequestDto>> RejectSupplyRequest(int id, [FromBody] RejectSupplyRequestDto dto)
    {
        try
        {
