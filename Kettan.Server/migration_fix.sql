...
BEGIN TRANSACTION;
ALTER TABLE [SupplyRequestItems] ADD [IsBranchChecked] bit NOT NULL DEFAULT CAST(0 AS bit);

ALTER TABLE [SupplyRequestItems] ADD [IsPacked] bit NOT NULL DEFAULT CAST(0 AS bit);

ALTER TABLE [SupplyRequestItems] ADD [IsPicked] bit NOT NULL DEFAULT CAST(0 AS bit);

ALTER TABLE [SupplyRequestItems] ADD [IsRejectedDuringPicking] bit NOT NULL DEFAULT CAST(0 AS bit);

ALTER TABLE [SupplyRequestItems] ADD [PickingRejectionReason] nvarchar(500) NULL;

ALTER TABLE [SupplyRequestItems] ADD [SendQuantity] decimal(18,4) NULL;

ALTER TABLE [Orders] ADD [ArrivedAt] datetime2(3) NULL;

ALTER TABLE [Orders] ADD [ArrivedConfirmedByUserId] int NULL;

ALTER TABLE [Orders] ADD [CompletedAt] datetime2(3) NULL;

ALTER TABLE [Orders] ADD [CompletedByUserId] int NULL;

CREATE INDEX [IX_Orders_ArrivedConfirmedByUserId] ON [Orders] ([ArrivedConfirmedByUserId]);

CREATE INDEX [IX_Orders_CompletedByUserId] ON [Orders] ([CompletedByUserId]);

ALTER TABLE [Orders] ADD CONSTRAINT [FK_Orders_Users_ArrivedConfirmedByUserId] FOREIGN KEY ([ArrivedConfirmedByUserId]) REFERENCES [Users] ([UserId]) ON DELETE NO ACTION;

ALTER TABLE [Orders] ADD CONSTRAINT [FK_Orders_Users_CompletedByUserId] FOREIGN KEY ([CompletedByUserId]) REFERENCES [Users] ([UserId]) ON DELETE NO ACTION;

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260430125930_AddOrderWorkflowFields', N'10.0.5');

COMMIT;
GO

BEGIN TRANSACTION;
UPDATE SupplyRequests SET Status = 2 WHERE Status = 1 AND EXISTS (SELECT 1 FROM Orders WHERE RequestId = SupplyRequests.RequestId)

UPDATE SupplyRequests SET Status = 3 WHERE Status = 2 AND EXISTS (SELECT 1 FROM Orders WHERE RequestId = SupplyRequests.RequestId)

UPDATE SupplyRequests SET Status = 4 WHERE Status = 2 AND NOT EXISTS (SELECT 1 FROM Orders WHERE RequestId = SupplyRequests.RequestId)

UPDATE SupplyRequests SET Status = 6 WHERE Status = 4

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260430142350_FixStatusCollisions', N'10.0.5');
...
CREATE TABLE [OrderMessages] (
    ...
    CONSTRAINT [PK_OrderMessages] PRIMARY KEY ([MessageId]),
    CONSTRAINT [FK_OrderMessages_Orders_OrderId] FOREIGN KEY ([OrderId]) REFERENCES [Orders] ([OrderId]) ON DELETE NO ACTION,
    CONSTRAINT [FK_OrderMessages_Tenants_TenantId] FOREIGN KEY ([TenantId]) REFERENCES [Tenants] ([TenantId]) ON DELETE NO ACTION,
    CONSTRAINT [FK_OrderMessages_Users_SenderUserId] FOREIGN KEY ([SenderUserId]) REFERENCES [Users] ([UserId]) ON DELETE NO ACTION
);

CREATE INDEX [IX_OrderMessages_OrderId] ON [OrderMessages] ([OrderId]);

CREATE INDEX [IX_OrderMessages_SenderUserId] ON [OrderMessages] ([SenderUserId]);

CREATE INDEX [IX_OrderMessages_TenantId] ON [OrderMessages] ([TenantId]);

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260503100601_AddOrderMessages', N'10.0.5');

COMMIT;
GO

BEGIN TRANSACTION;
DECLARE @var147 nvarchar(max);
SELECT @var147 = QUOTENAME([d].[name])
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[ReturnItems]') AND [c].[name] = N'Reason');
IF @var147 IS NOT NULL EXEC(N'ALTER TABLE [ReturnItems] DROP CONSTRAINT ' + @var147 + ';');
ALTER TABLE [ReturnItems] DROP COLUMN [Reason];

ALTER TABLE [Returns] ADD [AcknowledgedAt] datetime2(3) NULL;

ALTER TABLE [Returns] ADD [AcknowledgedBy_UserId] int NULL;

ALTER TABLE [Returns] ADD [ArrivedAt] datetime2(3) NULL;

ALTER TABLE [Returns] ADD [ArrivedBy_UserId] int NULL;

ALTER TABLE [Returns] ADD [CompletedAt] datetime2(3) NULL;

ALTER TABLE [Returns] ADD [CompletedBy_UserId] int NULL;

ALTER TABLE [Returns] ADD [DispatchedAt] datetime2(3) NULL;

ALTER TABLE [Returns] ADD [DispatchedBy_UserId] int NULL;

ALTER TABLE [Returns] ADD [InspectedBy_UserId] int NULL;

ALTER TABLE [Returns] ADD [InspectingAt] datetime2(3) NULL;

ALTER TABLE [Returns] ADD [PickupLastUpdatedAt] datetime2(3) NULL;

ALTER TABLE [Returns] ADD [PickupScheduledAt] datetime2(3) NULL;

ALTER TABLE [Returns] ADD [PickupVehicleId] int NULL;

ALTER TABLE [Returns] ADD [RejectedAt] datetime2(3) NULL;

ALTER TABLE [Returns] ADD [RejectedBy_UserId] int NULL;

ALTER TABLE [Returns] ADD [RejectionReason] nvarchar(500) NULL;

ALTER TABLE [Returns] ADD [Status] tinyint NOT NULL DEFAULT CAST(0 AS tinyint);

ALTER TABLE [Returns] ADD [SubmittedAt] datetime2(3) NULL;

ALTER TABLE [Returns] ADD [SubmittedBy_UserId] int NULL;

ALTER TABLE [ReturnItems] ADD [Disposition] tinyint NOT NULL DEFAULT CAST(0 AS tinyint);

ALTER TABLE [ReturnItems] ADD [InspectionRemarks] nvarchar(500) NULL;

ALTER TABLE [ReturnItems] ADD [QuantityInspected] decimal(18,4) NULL;

ALTER TABLE [ReturnItems] ADD [ReasonCode] tinyint NOT NULL DEFAULT CAST(0 AS tinyint);

ALTER TABLE [ReturnItems] ADD [RestockBatchId] int NULL;

CREATE TABLE [ReturnMessages] (
    [MessageId] int NOT NULL IDENTITY,
    [TenantId] int NOT NULL,
    [ReturnId] int NOT NULL,
    [SenderUserId] int NOT NULL,
    [Content] nvarchar(2000) NOT NULL,
    [SentAt] datetime2(3) NOT NULL,
    CONSTRAINT [PK_ReturnMessages] PRIMARY KEY ([MessageId]),
    CONSTRAINT [FK_ReturnMessages_Returns_ReturnId] FOREIGN KEY ([ReturnId]) REFERENCES [Returns] ([ReturnId]) ON DELETE NO ACTION,
    CONSTRAINT [FK_ReturnMessages_Tenants_TenantId] FOREIGN KEY ([TenantId]) REFERENCES [Tenants] ([TenantId]) ON DELETE NO ACTION,
    CONSTRAINT [FK_ReturnMessages_Users_SenderUserId] FOREIGN KEY ([SenderUserId]) REFERENCES [Users] ([UserId]) ON DELETE NO ACTION
);

CREATE INDEX [IX_Returns_AcknowledgedBy_UserId] ON [Returns] ([AcknowledgedBy_UserId]);

CREATE INDEX [IX_Returns_ArrivedBy_UserId] ON [Returns] ([ArrivedBy_UserId]);

CREATE INDEX [IX_Returns_CompletedBy_UserId] ON [Returns] ([CompletedBy_UserId]);

CREATE INDEX [IX_Returns_DispatchedBy_UserId] ON [Returns] ([DispatchedBy_UserId]);

CREATE INDEX [IX_Returns_InspectedBy_UserId] ON [Returns] ([InspectedBy_UserId]);

CREATE INDEX [IX_Returns_PickupVehicleId] ON [Returns] ([PickupVehicleId]);

CREATE INDEX [IX_Returns_RejectedBy_UserId] ON [Returns] ([RejectedBy_UserId]);

CREATE INDEX [IX_Returns_SubmittedBy_UserId] ON [Returns] ([SubmittedBy_UserId]);

CREATE INDEX [IX_ReturnItems_RestockBatchId] ON [ReturnItems] ([RestockBatchId]);

CREATE INDEX [IX_ReturnMessages_ReturnId] ON [ReturnMessages] ([ReturnId]);

CREATE INDEX [IX_ReturnMessages_SenderUserId] ON [ReturnMessages] ([SenderUserId]);

CREATE INDEX [IX_ReturnMessages_TenantId] ON [ReturnMessages] ([TenantId]);

ALTER TABLE [ReturnItems] ADD CONSTRAINT [FK_ReturnItems_Batches_RestockBatchId] FOREIGN KEY ([RestockBatchId]) REFERENCES [Batches] ([BatchId]) ON DELETE NO ACTION;

ALTER TABLE [Returns] ADD CONSTRAINT [FK_Returns_Users_AcknowledgedBy_UserId] FOREIGN KEY ([AcknowledgedBy_UserId]) REFERENCES [Users] ([UserId]) ON DELETE NO ACTION;

ALTER TABLE [Returns] ADD CONSTRAINT [FK_Returns_Users_ArrivedBy_UserId] FOREIGN KEY ([ArrivedBy_UserId]) REFERENCES [Users] ([UserId]) ON DELETE NO ACTION;

ALTER TABLE [Returns] ADD CONSTRAINT [FK_Returns_Users_CompletedBy_UserId] FOREIGN KEY ([CompletedBy_UserId]) REFERENCES [Users] ([UserId]) ON DELETE NO ACTION;

ALTER TABLE [Returns] ADD CONSTRAINT [FK_Returns_Users_DispatchedBy_UserId] FOREIGN KEY ([DispatchedBy_UserId]) REFERENCES [Users] ([UserId]) ON DELETE NO ACTION;

ALTER TABLE [Returns] ADD CONSTRAINT [FK_Returns_Users_InspectedBy_UserId] FOREIGN KEY ([InspectedBy_UserId]) REFERENCES [Users] ([UserId]) ON DELETE NO ACTION;

ALTER TABLE [Returns] ADD CONSTRAINT [FK_Returns_Users_RejectedBy_UserId] FOREIGN KEY ([RejectedBy_UserId]) REFERENCES [Users] ([UserId]) ON DELETE NO ACTION;

ALTER TABLE [Returns] ADD CONSTRAINT [FK_Returns_Users_SubmittedBy_UserId] FOREIGN KEY ([SubmittedBy_UserId]) REFERENCES [Users] ([UserId]) ON DELETE NO ACTION;

ALTER TABLE [Returns] ADD CONSTRAINT [FK_Returns_Vehicles_PickupVehicleId] FOREIGN KEY ([PickupVehicleId]) REFERENCES [Vehicles] ([VehicleId]) ON DELETE NO ACTION;

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260503145918_AddReturnWorkflow_Full', N'10.0.5');

COMMIT;
GO

BEGIN TRANSACTION;
ALTER TABLE [Employees] ADD [Status] tinyint NOT NULL DEFAULT CAST(0 AS tinyint);

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260504024207_AddEmployeeStatus', N'10.0.5');

COMMIT;
GO

BEGIN TRANSACTION;
ALTER TABLE [Users] ADD [Status] tinyint NOT NULL DEFAULT CAST(0 AS tinyint);

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260504024609_AddUserStatus', N'10.0.5');

COMMIT;
GO

BEGIN TRANSACTION;
ALTER TABLE [Items] ADD [SupplierId] int NULL;
...
CREATE TABLE [Suppliers] (
    ...
    CONSTRAINT [FK_Suppliers_Tenants_TenantId] FOREIGN KEY ([TenantId]) REFERENCES [Tenants] ([TenantId]) ON DELETE NO ACTION
);
...
ALTER TABLE [Items] ADD CONSTRAINT [FK_Items_Suppliers_SupplierId] FOREIGN KEY ([SupplierId]) REFERENCES [Suppliers] ([SupplierId]) ON DELETE NO ACTION;

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260504160111_AddSupplier', N'10.0.5');
...
DROP INDEX [IX_Items_SupplierId] ON [Items];

DECLARE @var148 nvarchar(max);
SELECT @var148 = QUOTENAME([d].[name])
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Items]') AND [c].[name] = N'SupplierId');
IF @var148 IS NOT NULL EXEC(N'ALTER TABLE [Items] DROP CONSTRAINT ' + @var148 + ';');
ALTER TABLE [Items] DROP COLUMN [SupplierId];

CREATE TABLE [ItemSuppliers] (
    [ItemSupplierId] int NOT NULL IDENTITY,
    [ItemId] int NOT NULL,
    [SupplierId] int NOT NULL,
    [LinkedAt] datetime2(3) NOT NULL,
    CONSTRAINT [PK_ItemSuppliers] PRIMARY KEY ([ItemSupplierId]),
    CONSTRAINT [FK_ItemSuppliers_Items_ItemId] FOREIGN KEY ([ItemId]) REFERENCES [Items] ([ItemId]) ON DELETE NO ACTION,
    CONSTRAINT [FK_ItemSuppliers_Suppliers_SupplierId] FOREIGN KEY ([SupplierId]) REFERENCES [Suppliers] ([SupplierId]) ON DELETE NO ACTION
);

CREATE UNIQUE INDEX [IX_ItemSuppliers_ItemId_SupplierId] ON [ItemSuppliers] ([ItemId], [SupplierId]);

CREATE INDEX [IX_ItemSuppliers_SupplierId] ON [ItemSuppliers] ([SupplierId]);

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260505020627_AddItemSupplierJoinTable', N'10.0.5');
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260505204428_AddReportingFieldsAndUserStatus', N'10.0.5');
