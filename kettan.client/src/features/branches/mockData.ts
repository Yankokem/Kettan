...
const BRANCH_EMPLOYEE_ROSTERS: Record<number, BranchEmployee[]> = {
  1: [
    {
      ...
      firstName: 'Jasper',
      lastName: 'Mendoza',
      email: 'jasper.mendoza@kettan.local',
      position: 'Shift Lead',
    ...
    },
    {
      ...
      firstName: 'Paula',
      lastName: 'Santos',
      email: 'paula.santos@kettan.local',
      position: 'Barista',
    ...
    },
    {
      ...
      email: 'rico.delosreyes@kettan.local',
      position: 'Cashier',
  ...
  2: [
    ...
    },
    {
      ...
      firstName: 'Nikko',
      lastName: 'Panganiban',
      email: 'nikko.panganiban@kettan.local',
      position: 'Barista',
  ...
  3: [
    {
      ...
      firstName: 'Mina',
      lastName: 'Torres',
      email: 'mina.torres@kettan.local',
      position: 'Barista',
